<template>
  <div class="section">
    <div class="title is-4 has-text-centered-mobile">Scale this Recipe</div>
    <div class="columns field align-middle is-mobile">
      ...
      <div class="column">
        ...
        <div v-if="scaleType === RecipeScaleType.INGREDIENT" class='field'>
          <div class="field">
            <div class="control">
